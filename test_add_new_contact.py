...
class TestAddNewContact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        wd.find_element_by_name("photo").send_keys("C:\\fakepath\\photo.jpg")
        ...
        wd.find_element_by_name("company").send_keys("Company LLC")
        ...
        wd.find_element_by_name("mobile").send_keys("9876543210")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("1472583690")
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("3692580147")
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys("pert@mal.com")
        wd.find_element_by_name("email2").click()
        wd.find_element_by_name("email2").clear()
        wd.find_element_by_name("email2").send_keys("pert2@mail.com")
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys("pert3@mail.com")
        wd.find_element_by_name("homepage").click()
        wd.find_element_by_name("homepage").clear()
        wd.find_element_by_name("homepage").send_keys("homepaga.com")
        ...
        wd.find_element_by_name("phone2").send_keys("my home")
